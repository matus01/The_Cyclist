...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        bool UnshareNavMeshAsset()
        {
            ...
            //    return false;
            UnityEditor.PrefabAssetType prefabAssetType = UnityEditor.PrefabUtility.GetPrefabAssetType(this);
            if (prefabAssetType == UnityEditor.PrefabAssetType.Regular || prefabAssetType == UnityEditor.PrefabAssetType.Variant)
            {
                return false;
            }
            ...
            //    return false;
            NavMeshSurface navMeshSurface = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource<NavMeshSurface>(this);
            if (navMeshSurface && navMeshSurface.navMeshData == navMeshData)
            {
                return false;
            }
